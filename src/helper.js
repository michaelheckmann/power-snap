...
export function applyBorderRadius(context, x, y, width, height, radius) {
  context.beginPath();
...
export function createBackground(context, width, height, from, to) {
...
export function applyShadow(context, position, color, blur, x, y) {
